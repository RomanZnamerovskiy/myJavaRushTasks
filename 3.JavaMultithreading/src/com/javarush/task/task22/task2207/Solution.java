...
//    private static List<Pair> findNeededWords(List<String> list) {
//        List<Pair> listPair = new LinkedList<>();
//        for (int i = 0; i < list.size(); i++) {
//            String s = list.get(i);
//            for(int j = i + 1; j < (list.size() - 1); j++) {
//                String sj = list.get(j);
//                StringBuilder stringBuilder = new StringBuilder(sj);
//                if (s.equals(sj) || s.equals(stringBuilder.reverse().toString())) {
//                    Pair pair = new Pair();
//                    pair.first = s;
//                    pair.second = sj;
//                    listPair.add(pair);
